...
Model = GEO.Model(elementRes=(296,196), #296,160 #296,128, #120,64
                  minCoord=(-1800. * u.kilometer, -1400.0 * u.kilometer), 
                  maxCoord=(1800. * u.kilometer, 0.0 * u.kilometer),
                  gravity=(0.0, -9.81 * u.meter / u.second**2))

#Model Output Folder
Model.outputDir = "28km_MantleContrast_100_D_3488_Final"
...
#Arc Crust
data4=PlateProperties(4,7.,2900.,3400.,100.,True,80.,12.5,12.5,0.066,0.033,True,2838.,28.,100.,2.)
#eclogite-Properties
...
LMantle.viscosity =  100*refV* u.pascal * u.second
