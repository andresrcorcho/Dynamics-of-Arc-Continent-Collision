...
#Model Output Folder
Model.outputDir = "25km_MantleContrast_30_D_3546_SuperStrongerOP_Final"
...
OArc1.minViscosity=10**(21) * u.pascal * u.second
...
Clithosphereweak1.plasticity = GEO.DruckerPrager(cohesion=15. * u.megapascal,
                                                 frictionCoefficient=0.02,#Mean from Lower and Upper from Rey et al., 2014
